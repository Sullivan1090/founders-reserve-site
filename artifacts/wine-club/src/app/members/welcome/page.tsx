  ...
  return (
    ...
    >
      <div className="max-w-xl w-full text-center space-y-10">
        ...
        >
          Welcome to the Founder's Vault
        </h1>
        ...
        <div className="space-y-7 text-left">
          {[
            ...
            "To hold a place in the Founder's Reserve allocation is to be family. The Founder's Vault is where that relationship lives: your one place for complete access to everything we do, not just the wine, but every endeavor we pursue.",
